...
public class AnnouncementDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sLocation.setText("Location : "+location);
        sTitle.setText("Title : "+title);
        sDes.setText("Description : "+des);
        Glide.with(this)
                .asBitmap()
                .load(image)
                .into(imageView);
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(AnnouncementDetail.this,MainMenu.class);
